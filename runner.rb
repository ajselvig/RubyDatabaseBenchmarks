...
class Runner
  ...
  attr_accessor :insert_time, :read_time, :update_time
  ...
  def run
    ...
    puts "Total insert time: #{@insert_time.round(2)} seconds (#{(n/@insert_time).round(1)} inserts/second)"

    @read_time = timed_run {run_read}
    puts "Total read time: #{@read_time.round(2)} seconds (#{(n/@read_time).round(1)} reads/second)"

    @update_time = timed_run {run_update}
    puts "Total update time: #{@update_time.round(2)} seconds (#{(n/@update_time).round(1)} updates/second)"
